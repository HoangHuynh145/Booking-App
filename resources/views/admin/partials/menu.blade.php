...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="/" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold ms-2">Sconnect</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item @if($menu == 'role') active @endif">
            <a href="#" class="menu-link">
                <i class="menu-icon tf-icons mdi mdi-arm-flex-outline"></i>
                <div>Quản lý Quyền</div>
            </a>
        </li>
        <li class="menu-item @if($menu == 'user') active @endif">
            <a href="#" class="menu-link">
